...
rule RevGeneratePlots:
    input:
        "analysis/multiple_slices/features_normalized/subject/{valid_slices}/{folder}.csv",
    output:
        "analysis/multiple_slices/plots/subject/features_curves/{valid_slices}/{folder}/top12_features.png"
    conda:
        "../tidyverse.yaml"
    script:
...
rule RevGenerateMaePlots:
    ...
    output:
        "analysis/multiple_slices/tables/{valid_slices}/rank_table_subject.csv",
        "analysis/multiple_slices/plots/{valid_slices}/subject/total_mae_vs_snr_mae.png",
        "analysis/multiple_slices/plots/{valid_slices}/subject/total_mae_vs_snr_mae_1.png",
        "analysis/multiple_slices/plots/{valid_slices}/subject/rank_barcode.png",
    conda:
        "../tidyverse.yaml"
    script:
        "../../code/mae_plots.R"
